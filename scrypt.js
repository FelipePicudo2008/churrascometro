...
const inputAdultos = document.getElementByld("aultos");
const inputCriancas = document.getElementByld("criancas");
const inputDuracao = document.getELementByld("duracao");
